...
age = 16
shirt = "White"
print(f"Hello {name} you are {age} years old , and wearing a {shirt} shirt.")
...
age = 16
shoes = "Air force 1s"
print(f"Hello {name} you are {age} years old , and wearing {shoes}.")

name = "German"
age = 16
pants = "jeans"
print(f"Hello {name} you are {age} years old , and wearing {pants}.")
